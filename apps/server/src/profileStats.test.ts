        ...
        yield* sql`
          ...
          VALUES
            (
              ...
              'project-profile',
              'Codex Thread',
              '{"provider":"opencode","model":"gpt-5-codex","options":{"reasoningEffort":"high"}}',
              'full-access',
              'default',
              'local',
            ...
            (
              ...
              'project-profile',
              'Claude Thread',
              '{"provider":"opencode","model":"claude-sonnet-4-6","options":{"effort":"max"}}',
              'full-access',
              'default',
              'local',
        ...
        yield* sql`
          ...
          VALUES
            (
              ...
              '2026-06-13T09:05:00.000Z',
              'client',
              '{"threadId":"thread-codex","modelSelection":{"provider":"opencode","model":"gpt-5-codex","options":{"reasoningEffort":"high"}}}',
              '{}'
            ),
            (
              'event-codex-2',
            ...
            (
              ...
              '2026-06-14T10:05:00.000Z',
              'client',
              '{"threadId":"thread-claude","modelSelection":{"provider":"opencode","model":"claude-sonnet-4-6","options":{"effort":"max"}}}',
              '{}'
            )
        `;
        ...
        yield* sql`
          ...
          VALUES
            (
              ...
              'project-profile',
              'Skill Thread',
              '{"provider":"opencode","model":"gpt-5-codex"}',
              'full-access',
              'default',
              'local',
