      ...
      className={cn(
        isContentSeam
          ...
          : [
              ...
              "-translate-x-1/2 group-data-[side=left]:-right-4 absolute inset-y-0 z-30 hidden w-5 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:-translate-x-1/2 after:bg-transparent after:transition-colors hover:after:bg-sidebar-border group-data-[side=right]:left-0 sm:flex [[data-collapsible=offcanvas][data-state=collapsed]_&]:pointer-events-none",
