        ...
        >
          ...
          >
            ...
            >
              ...
              <h1 className="truncate font-heading text-sm font-medium">自动化</h1>
            </div>
          </header>
              ...
              <div className="flex shrink-0 items-center gap-1 [-webkit-app-region:no-drag]">
                {canPauseAutomation(definition) ? (
                  <Button
                    ...
                    size="icon-sm"
                    variant="ghost"
                    aria-label={definition.enabled ? "暂停" : "恢复"}
                    title={definition.enabled ? "暂停" : "恢复"}
                    onClick={togglePause}
                  >
                ...
                <Button
                  ...
                  title={
                    approvalGaps.runBlockingWarnings.length > 0 ? "请先批准该自动化" : undefined
                  }
            ...
            <div className="flex flex-col gap-6 px-4 py-8">
              ...
              <DetailGroup title="详情">
                {definition.mode === "heartbeat" ? (
                  <DetailRow label="运行于">会话</DetailRow>
                ) : (
                  <EditRow
                    label={
                      <>
                ...
                {definition.mode === "heartbeat" ? (
                  <DetailRow label="项目">{project?.name ?? "未知项目"}</DetailRow>
                ) : (
                  <EditRow label="项目">
                    <InlineSelect
                ...
                {definition.mode === "heartbeat" ? (
                  <DetailRow label="会话">
                    {targetThread ? resolveThreadPickerTitle(targetThread.title) : "会话不可用"}
                  </DetailRow>
                ) : null}
              </DetailGroup>
              ...
              <DetailGroup title="历史运行">
                {runs.length === 0 ? (
                  <div className="px-1.5 py-1 text-xs text-muted-foreground">暂无运行记录。</div>
                ) : (
